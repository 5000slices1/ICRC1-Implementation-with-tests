...
import Account "../../../src/ICRC1/Modules/Token/Account/Account";
...
module {
                ...
                it(
                    ...
                    do {
                        ...
                        assertAllTrue([
                            ...
                            Account.fromText("prb4z-5pc7u-zdfqi-cgv7o-fdyqf-n6afm-xh6hz-v4bk4-kpg3y-rvgxf-iae") == #ok {
                                account with subaccount = null
                            },
                            Account.toText(account) == "prb4z-5pc7u-zdfqi-cgv7o-fdyqf-n6afm-xh6hz-v4bk4-kpg3y-rvgxf-iae",
                            Account.validate(account),
                        ]);
                ...
                it(
                    ...
                    do {
                        ...
                        label _loop while (len < 32) {
                            ...
                            is_valid := is_valid or Account.validate(account) or Account.validate_subaccount(account.subaccount);
    ...
    func GetAssertParamForEncodeCheck(principalText : Text, subaccount : ?[Nat8], expectedText : Text, description : Text) : ActorSpec.AssertParam<Text, Text> {
    ...
    func GetAssertParamForDecodeCheck(
        accountText : Text,
        expectedResult : Result.Result<T.AccountTypes.Account, T.AccountTypes.ParseError>,
        description : Text,
    ) : ActorSpec.AssertParam<Result.Result<T.AccountTypes.Account, T.AccountTypes.ParseError>, Result.Result<T.AccountTypes.Account, T.AccountTypes.ParseError>> {

        let account = Account.fromText(accountText);

        let returnValue : ActorSpec.AssertParam<Result.Result<T.AccountTypes.Account, T.AccountTypes.ParseError>, Result.Result<T.AccountTypes.Account, T.AccountTypes.ParseError>> = {
            actual = ?account;
